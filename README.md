...
QZip 是一款开源、跨平台、轻量化的桌面压缩工具。当前仓库处于 M1：工程骨架、设计系统和 7-Zip 后端技术验证阶段。
...
Windows 打包需要先拉取 Sidecar，再执行 `pnpm tauri:bundle:windows`；资源映射仅在该打包配置中启用，因此普通开发/CI 构建不需要下载二进制。
