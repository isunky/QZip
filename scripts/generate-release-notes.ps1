...
$notes.Add("- macOS 安装包：``QZip-$Version-macos-arm64.dmg``（Apple Silicon）和 ``QZip-$Version-macos-x64.dmg``（Intel）。")
$notes.Add('- macOS 校验：`SHA256SUMS-macos-arm64.txt` 和 `SHA256SUMS-macos-x64.txt`。')
