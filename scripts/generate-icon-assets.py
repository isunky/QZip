...
Requires Pillow. The application uses one fixed brand icon across all themes.
Native file association icons are copied from the paper-cut assets generated by
build-file-type-icons.py.
"""
